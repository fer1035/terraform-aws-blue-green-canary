...
> The [full example code](https://github.com/fer1035/terraform-aws-blue-green-canary/tree/v1.1.5/examples) shows a more elaborate configuration using multiple modules and web server Instances separate from this module for more modular target attachments.

The following prerequisites are for the [simple example](https://github.com/fer1035/terraform-aws-blue-green-canary/tree/v1.1.5/examples):
